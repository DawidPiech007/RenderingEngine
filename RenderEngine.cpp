...
int main()
{
    ...
    // Kula w miejscu światła
    //objects.push_back(new Sphere(Vector3(-4.0f, 4.0f, -4.0f), 0.3f));
    ...
    vector<Light*> lights{ new PointLight(LightIntensity(1.0f,1.0f,1.0f), Vector3(-3.0f, 0.0f, -6.0f), 1.0f, 1.0f, 1.0f),
